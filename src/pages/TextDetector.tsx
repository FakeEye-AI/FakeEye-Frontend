...
export function TextDetector() {
  ...
  const exampleTexts = [
    ...
    },
    {
      ...
      text: "I couldn't believe it. The coffee shop was empty—totally empty. Where was everyone? It's Monday morning, for crying out loud! But there I was, standing in this weird silence, holding my phone like it might explain everything. It didn't.",
    },
    {
